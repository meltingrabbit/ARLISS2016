...
//			strcpy(Gps_W_or_E, Gps_Raw_Arr[5]);
			...
			Gps_Lat = atof(Gps_Raw_Arr[2]);			//char→double
			//Gps_Long = atof(Gps_Long_Raw);
			Gps_Long = atof(Gps_Raw_Arr[4]);

			if (strcmp(Gps_Raw_Arr[5], "W")) {			// W だとtrue
				Gps_Long = -1 * Gps_Long;
...
//{
//	latRad = Deg2Rad(int(Gps_Lat)) - Deg2Rad((Gps_Lat - (int)Gps_Lat));
//
//	latRad = Deg2Rad( ddmm2dd(Gps_Lat) );
//
//}


//double Deg2Rad(deg) {
//	return deg * M_PI / 60.0;
//}
//
//double ddmm2dd(ddmm){
//	return ddmm + (ddmm - (int)ddmm) / 60.0;
//}
