...
long GPS_LIGHT_JUDGE_TIMEOUT_SEC = 60;		//単位は(秒) この二つのTIMEOUT_SECの和が、着地判定自体のタイムアウト時間
...
// 最寄りの砂漠
const long TARGET_LATITUDE = 40699339;
const long TARGET_LONGITUDE = -119342667;
...
void loop() {
	...
	// 西側
	long passingLatitudes1[] = {40699339, 40699339};
	long passingLongitudes1[] = {-119342667, -119342667};
	// 東側
	long passingLatitudes2[] = {40699339, 40699339};
	long passingLongitudes2[] = {-119342667, -119342667};
...
void JudgeLandingGpsLightMode() {		//ver.3.04.01から三軸完全一致
	...
	while(1) {			//!!!gps判定ループ!!!
		...
		if(countGpsData >= sampleNumMin){		//!!!判定!!!
			rateMatchedGpsData = countMatchedGpsData * 1.0 / countGpsData;
