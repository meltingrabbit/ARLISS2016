...
int Magnet_Z12 = 0;
int Magnet_Y12 = 0;
double MAGNET_X_OFFSET = 240.0;
double MAGNET_Y_OFFSET = 60.0;
double MAGNET_XY_RATIO = 1.03;
...
void loop() {
	...
	// 東側
	long passingLatitudes2[] = {40868500, 40874137};
...
void RunUpNearGoal(double residualError) {
	...
	while(1) {
		...
		// 進む
		goStraightMeter = Gps_Passing_Distance * 0.5;
...
void ApproachGoal(double residualError) {
	...
	while(1) {
		...
		// 進む
		goStraightMeter = Gps_Distance * 0.4;
