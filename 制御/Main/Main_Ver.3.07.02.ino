...
void MyPrintRemainingTimeln(unsigned long startTimeMsec, long timeLimitSec);
// #########################################
...
void MyPrintRemainingTimeln(unsigned long startTimeMsec, long timeLimitSec) {
	long remainingTimeSec = timeLimitSec + (startTimeMsec - millis()) * 1.0 / 1000;
