...
//	error = InitializeGps();
	...
	Serial.println(strlen(charstr));
	Serial.println( charstr[strlen(charstr)-1] );
...
//	char charstr[100];
//	str.toCharArray(charstr, 3);
//	Serial.println(charstr);
//	str.toCharArray(charstr, 5);
//	Serial.println(charstr);
//	str.toCharArray(charstr, 10);
//	Serial.println(charstr);
}
