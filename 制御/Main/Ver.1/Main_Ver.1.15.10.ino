...
void loop() {
	...
	Serial.println("KITA");
	Serial.println(SetRoverAngle(0, 40));
	delay(5000);
	Serial.println("MINAMI");
	Serial.println(SetRoverAngle(M_PI, 40));
	delay(5000);
	Serial.println("HIGASHI");
	Serial.println(SetRoverAngle(M_PI / 2, 40));
	delay(5000);
	Serial.println("NISHI");
	Serial.println(SetRoverAngle(M_PI * 3 / 2, 40));
	delay(5000);
...
//	Serial.print(Rad2Deg( NormalizeRad(Gps_Radian)) );
//	Serial.println("");
//	magnetRad = GetMagnetRadNTimes(10);
//	Serial.print("NowDeg : ");
//	Serial.print(Rad2Deg( NormalizeRad( magnetRad ) ));
//	Serial.print(", X : ");
...
//	Serial.print(Rad2Deg( NormalizeRadSym( Gps_Radian - magnetRad ) ));
//	Serial.println("");
//	Serial.println("");
