...
//	RunUpNearGoal(3.0);
	...
	GoStraight(Deg2Rad(10), Meter2Msec(10));
	delay(1000);
	GoStraight(Deg2Rad(100), Meter2Msec(10));
	delay(1000);
	GoStraight(Deg2Rad(190), Meter2Msec(10));
	delay(1000);
	GoStraight(Deg2Rad(280), Meter2Msec(10));
	delay(1000);
	GoStraight(Deg2Rad(0), Meter2Msec(10));
	delay(1000);
...
//・LogGspのheightをsprintf lessコードに修正。
//・LogComの実装
//・eeprom → sd以外でもsd書き込み時は音を鳴らす
//・末端誘導
//・sd破損時の処理
//・pidのログ付