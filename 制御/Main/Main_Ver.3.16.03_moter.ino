...
void loop() {
	...
	// 西側
	long passingLatitudes1[] = {40870944, 40871044};
	long passingLongitudes1[] = {-119106771, -119106771};
	// 東側
	long passingLatitudes2[] = {40870944, 40871044};
	long passingLongitudes2[] = {-119106571, -119106571};
...
void EscapeLandingPoint() {
	...
	if (DEBUG) MyPrintln(F("OP : GoStraight (Burst) 1, 4m"));
	Adjust_Moter_Power = 1;
	magnetRad = NormalizeRadSym(GetMagnetRadNTimes(5));
	GoStraight(magnetRad, Meter2Msec(4));
