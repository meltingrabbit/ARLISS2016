...
//	error = InitializeGps();
	...
	EEPROM.update(100, '1');
	EEPROM.update(200, 100);
	EEPROM.update(300, 'a');

	EEPROM.update(100 + 1024 * 4, '2');
	EEPROM.update(200 + 1024 * 4, 101);
	EEPROM.update(300 + 1024 * 4, 'b');



	Serial.println(EEPROM[100]);
	Serial.println(EEPROM[200]);
	Serial.println(EEPROM[300]);
	Serial.println(EEPROM[100 + 1024 * 4]);
	Serial.println(EEPROM[200 + 1024 * 4]);
	Serial.println(EEPROM[300 + 1024 * 4]);
...
void loop() {
	int MAX_ADDRESS = 10 * 8192 - 1 + 100;
	char eepromVal;

	for (int i = 0; i <= MAX_ADDRESS; i+=100) {
		Serial.print(i);
		Serial.print("\t");
